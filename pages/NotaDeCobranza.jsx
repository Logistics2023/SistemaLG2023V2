...
function CotizacionTerrestre() {
    ...
    const adminName = userDB?.admins?.[user?.uid]?.name || ''
    ...
    function handlerFilterButton(e) {
        ...
        let f = users[filter] ? users[filter] : obj
                    ...
                    <div className={style.containerFirstItems}>
                        <div className={style.firstItems}>
                            <div>
                                ...
                                <input type="text" name={"BANCO"} value={bankData.banco || ''} readOnly />
                            </div>
                            <div>
                                <label htmlFor="">DIRECCION DE BANCO</label>
                                <input type="text" name={"DIRECCION DE BANCO"} value={bankData.direccionDeBanco || ''} readOnly />
                            </div>
                            <div>
                                <label htmlFor="">CODIGO SWIFT</label>
                                <input type="text" name={"CODIGO SWIFT"} value={bankData.codigoSWIFT || ''} readOnly />
                            </div>
                            <div>
                                <label htmlFor="">NUMERO DE CUENTA EN BS</label>
                                <input type="text" name={"NUMERO DE CUENTA EN BS"} value={bankData.cuentaEnBS || ''} readOnly />
                            </div>
                            <div>
                                <label htmlFor="">NUMERO DE CUENTA EN USD</label>
                                <input type="text" name={"NUMERO DE CUENTA EN USD"} value={bankData.cuentaEnUSD || ''} readOnly />
                            </div>
                            <div>
                                <label htmlFor="">TIPO DE CUENTA</label>
                                <input type="text" name={"TIPO DE CUENTA"} value={bankData.tipoDeCuenta || ''} readOnly />
                            </div>
                            <div>
                                <label htmlFor="">NOMBRE</label>
                                <input type="text" name={"NOMBRE2"} value={bankData.nombre2 || ''} readOnly />
                            </div>
                            <div>
                                <label htmlFor="">DIRECCION</label>
                                <input type="text" name={"DIRECCION"} value={bankData.direccion || ''} readOnly />
                            </div>
                        </div>
                    </div>
                </form>
