        ...
        <Layout> 
            ...
            <div className={style.container}>
                ...
                <div className={style.grid}>
                    ...
                    <Card img="/015-invoice-1.svg" buttonText={"Factura"} click={(e) => redirection("Factura")} />
                    <Card img="/015-invoice-1.svg" buttonText={"Mis Facturas"} click={(e) => redirection("FacturasLista")} />
