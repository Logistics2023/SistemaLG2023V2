...
function CotizacionTerrestre() {
    ...
    function generateNO() {
        ...
        const nextCounter = (userDB.CotizacionTerrestre || 0) + 1
        let cotizacionNo = `${nextCounter < 10 ? '00' : ''}${nextCounter > 9
            && nextCounter < 100 ? '0' : ''}${nextCounter}/${new Date().getFullYear().toString().substring(2, 4)}`
        ...
        let object = {
            CotizacionTerrestre: nextCounter
        }
