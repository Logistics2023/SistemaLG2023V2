...
import { mergePdfDefaults } from "../utils/pdfDefaults";
...
const PDFView = () => {
    const {userDB, pdfData, setUserPdfData } = useUser()
    ...
    useEffect(() => {
        setisCliente(true)
        setUserPdfData((prev) => mergePdfDefaults(prev, {
            tarifa: [''],
            otrosGastos: [''],
            incluye: [''],
            excluye: [''],
                    ...
                    <Page style={styles.body} >
                        ...
                        <View style={styles.items}>
                            <View style={styles.viewKeyValueTwo}>
                                ...
                                <Text style={styles.value}>{bankData.banco || ''}</Text>
                            </View>
                            <View style={styles.viewKeyValueTwo}>
                                <Text style={styles.key}>DIRECCIÓN DE BANCO</Text>
                                <Text style={styles.value}>{bankData.direccionDeBanco || ''}</Text>
                            </View>
                            <View style={styles.viewKeyValueTwo}>
                                <Text style={styles.key}>CODIGO SWIFT</Text>
                                <Text style={styles.value}>{bankData.codigoSWIFT || ''}</Text>
                            </View>
                            <View style={styles.viewKeyValueTwo}>
                                <Text style={styles.key}>NÚMERO DE CUENTA EN BS</Text>
                                <Text style={styles.value}>{bankData.cuentaEnBS || ''}</Text>
                            </View>
                            <View style={styles.viewKeyValueTwo}>
                                <Text style={styles.key}>NÚMERO DE CUENTA EN USD</Text>
                                <Text style={styles.value}>{bankData.cuentaEnUSD || ''}</Text>
                            </View>
                            <View style={styles.viewKeyValueTwo}>
                                <Text style={styles.key}>TIPO DE CUENTA</Text>
                                <Text style={styles.value}>{bankData.tipoDeCuenta || ''}</Text>
                            </View>
                            <View style={styles.viewKeyValueTwo}>
                                <Text style={styles.key}>NOMBRE</Text>
                                <Text style={styles.value}>{bankData.nombre2 || ''}</Text>
                            </View>
                            <View style={styles.viewKeyValueTwo}>
                                <Text style={styles.key}>DIRECCIÓN</Text>
                                <Text style={styles.value}>{bankData.direccion || ''}</Text>
                            </View>
                        </View>
