                            ...
                            pdfData.otrosGastos && pdfData.otrosGastos.map((i, index) => {
                                return (
                                    ...
                                    <View style={styles.viewKeyValueTwo} key={index}>
                                        ...
                                        <Text style={styles.value}>{pdfData && pdfData[`CA-DETALLEADICIONAL${index}`] && pdfData[`CA-DETALLEADICIONAL${index}`]}</Text>
                       ...
                       <Text style={styles.subtitle}>NOTAS</Text>
                        {
                            pdfData.notas && pdfData.notas.map((i, index) => {
                                return (
                                    ...
                                    <View style={styles.viewKeyValueTwo} key={index}>
                                        <Text style={styles.valueTwo}>{pdfData[`CA-NOTAS${index}`]}</Text>
                                    </View>
                                )
                            })
                        }
